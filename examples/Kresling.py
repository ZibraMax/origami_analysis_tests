...
Nmodes = 7
number_sides = n
basename = f"Kresling_n_{number_sides}_b_{b}_h_{H}_h0_{H0}_t_{thickness}_kf_{khinge}_poaso_{POSAO}_E_{BASE_E}_mrf_{mesh_refinement}_EIGV_SCALE_{EIGV_SCALE}"
if OPEN:
